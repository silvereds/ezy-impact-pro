...
<template>
    <div class="mt-2 bg-red h-100">
        ...
        <div class="pa-2">
            <Table 
                title="Equipement Froid Chaleur" 
                subtitle="cliquer sur nouveau pour ajouter un nouvel équipement" 
        ...
        >
            <template #header>
                <div class="flex flex-row align-items-center justify-content-start gap-2 w-100">
                    ...
                    <span style="font-size:18px;font-weight:600"> Nouvel Equipement froid chaleur  </span>
                </div>
            </template>
