...
onMounted(()=>{
    if(props?.defaultId){
        console.log("default id" , props.defaultId)
    }
})
        ...
        <div class="flex align-items-center flex-column justify-content-center w-100">
            ...
            <div class="flex flex-row align-items-center justify-content-between mt-3">
                ...
                <div class="flex flex-column ml-2 gap-2">
                    <label> Type </label>
                    <Dropdown  v-model="data.type" :options="type" optionLabel="frName" class="input-ezy" />
                </div>
            </div>
            <div class="flex flex-row align-items-center justify-content-between mt-5">
                <div class="flex flex-column gap-2">
                    <label> Combustible utilisé </label>
                    <Dropdown  v-model="data.fuelUsed" :options="fuelUsed" optionLabel="frName" class="input-ezy" />
                </div>
                <div class="flex flex-column ml-2 gap-2">
            ...
            <div class="flex flex-row align-items-center justify-content-between mt-5">
                <div class="flex flex-column gap-2">
                    ...
                    <Dropdown  v-model="data.location" :options="building" optionLabel="frName" class="input-ezy" />
                </div>
                <div class="flex flex-column ml-2 gap-2">
                    <label> Déclarant </label>
                    <Dropdown  v-model="data.declarer" :options="declarer" optionLabel="frName" class="input-ezy" />
                </div>
            </div>
            <div class="flex flex-row align-items-center justify-content-between mt-5">
                <div class="flex flex-column gap-2">
                ...
                <div class="flex flex-column ml-2 gap-2">
                    ...
                    <Dropdown  v-model="data.owner" :options="owner" optionLabel="frName" class="input-ezy" />
                </div>
            </div>
