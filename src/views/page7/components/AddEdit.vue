...
import Store from "@/stores/BIOMASS_ACT/store";
...
const { type, measurement}:any = getSelectable.value(SCOPE.BIOMASS_ACTIVITY,['type','measurement'])
...
const onSave = ()=>{
    ...
    console.log("ges activity  to save",d)
